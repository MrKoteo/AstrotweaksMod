...
public class ConfigManager {
	...
	public static void loadValues() {
		...
		try {
			...
			ModVariables.GG_ENABLED = safeGetBoolean(config, "GG_ENABLED", "world", ModVariables.GG_ENABLED, "Enable Grass growth? (y/n)");
			ModVariables.GG_MIN_DELAY_TICK = safeGetInt(config, "Grass_Growth_MIN_Delay", "world", ModVariables.GG_MIN_DELAY_TICK, 1, 1728000, "Minimum delay (ticks) for grass regrowth (10-1728000)");
			ModVariables.GG_MAX_DELAY_TICK = safeGetInt(config, "Grass_Growth_MAX_Delay", "world", ModVariables.GG_MAX_DELAY_TICK, 2, 1728000, "Maximum delay (ticks) for grass regrowth (10-1728000)");
